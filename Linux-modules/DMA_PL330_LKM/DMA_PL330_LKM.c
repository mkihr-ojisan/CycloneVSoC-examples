 ...
 */
static struct kobj_attribute dma_buff_padd_attr = __ATTR(dma_buff_padd, 0664, dma_buff_padd_show, dma_buff_padd_store);
static struct kobj_attribute use_acp_attr = __ATTR(use_acp, 0664, use_acp_show, use_acp_store);
static struct kobj_attribute prepare_microcode_in_open_attr = __ATTR(prepare_microcode_in_open, 0664,
  prepare_microcode_in_open_show, prepare_microcode_in_open_store);
static struct kobj_attribute dma_transfer_size_attr = __ATTR(dma_transfer_size, 0664,
  dma_transfer_size_show, dma_transfer_size_store);
static struct kobj_attribute lockdown_cpu_attr = __ATTR(lockdown_cpu, 0664,
  lockdown_cpu_show, lockdown_cpu_store);
static struct kobj_attribute lockdown_acp_attr = __ATTR(lockdown_acp, 0664,
  lockdown_acp_show, lockdown_acp_store);
static struct kobj_attribute sdramc_priority_attr = __ATTR(sdramc_priority, 0664,
  sdramc_priority_show, sdramc_priority_store);
static struct kobj_attribute sdramc_weight0_attr = __ATTR(sdramc_weight0, 0664,
  sdramc_weight0_show, sdramc_weight0_store);
static struct kobj_attribute sdramc_weight1_attr = __ATTR(sdramc_weight1, 0664,
